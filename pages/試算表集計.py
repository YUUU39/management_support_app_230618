...
expander1.write("このダッシュボードで、月次の損益試算表を確認することが出来ます。")
expander2 = st.expander("・賃貸対照表")
expander2.write("賃貸対照表は「決算日時点の企業の財務状態」を表します。")
expander2.write("前年度のものは、別途、経理部にご確認下さい")
